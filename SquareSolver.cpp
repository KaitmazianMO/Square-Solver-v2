...
/*!
    \brief ћаксимально возможный размер входной строки,
           используетс€ в функции GetArgs().
*/
const size_t INPUT_STR_SIZE = 1000;
/*!
    \brief »спользуетс€ в качестве возвращаемого
           значени€ в функции SolveSquare(),
           говорит о том, что коней бесконечно много.
*/
const int    INF            = -1;
/*!
    \brief »спользуетс€ в функции isZero(),
           устанавливает погрешность, согласно
           которой число считаетс€ равным 0.
*/
const double PRECISION      = 1E-8;

/*!
   \brief Ќаходит корни квадратного уравнени€
          вида ax^2 + bx + c = 0
...
/*!
    \brief «аписыает числа введеные в консоль в
           переменные согласно указател€м на них.

    ѕреобразует строку, введенную в консоль,
    в числа и записывает их значени€ в переменные
    по указател€м.

    \param[in] pa, pb, pc - указатели на переменные,в
                            которые нужно записать занчени€;

    \param[in] str_size   - маскимальный размер входной строки,
                            по умолчанию принимает значение
                            INPUT_STR_SIZE;

    \return  оличество считанных аргументов.
*/
...
/*!
    \brief —равнивает число с 0, согласно погрешности.

    \param[in] value     - число, которое сравниваетс€ с 0;
    \param[in] precision - погрешность, согласно которой
                           число сравниваетс€ с 0, по умолчанию
                           считаетс€ равной PRECISION;
*/
...
/*!
    \brief “есты дл€ функции SolveSquare().
*/
